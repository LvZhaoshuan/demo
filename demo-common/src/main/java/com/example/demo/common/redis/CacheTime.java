...
public class CacheTime {
     ...
     * 缓存时效 12小时
     */
    public static final int CACHE_EXP_HALF_DAY = 60 * 60 * 12;

    /**
     * 缓存时效 1天
     */
    public static final int CACHE_EXP_DAY = 60 * 60 * 24;

    /**
     * 缓存时效 1周
     */
    public static final int CACHE_EXP_WEEK = 60 * 60 * 24 * 7;

    /**
     * 缓存时效 1月
     */
    public static final int CACHE_EXP_MONTH = 60 * 60 * 24 * 30;
